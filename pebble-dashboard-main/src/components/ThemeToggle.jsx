...
export function ThemeToggle() {
    ...
    return (<button onClick={() => setTheme(theme === "dark" ? "light" : "dark")} className={cn("relative p-3 rounded-full transition-all duration-300", "bg-card border border-border shadow-card", "hover:shadow-hover hover:scale-105")} aria-label="Toggle theme">
